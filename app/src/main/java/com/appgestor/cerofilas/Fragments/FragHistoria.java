...
public class FragHistoria extends Fragment {
    ...
    public static FragHistoria newInstance(int param1) {
        FragHistoria fragment = new FragHistoria();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_historia, container, false);
